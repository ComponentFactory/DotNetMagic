...
namespace SampleMenus
{
    public class MDIContainer : System.Windows.Forms.Form
    {
        ...
        private StatusBarControl _status = null;
        private StatusPanel _statusBarPanel = null;
		private StatusPanel _statusBarPanelTime = null;
		private Crownwood.DotNetMagic.Menus.MenuControl _topMenu = null;
        ...
        protected void SetupMenus()
        {
            ...
            _topMenu = new Crownwood.DotNetMagic.Menus.MenuControl();
			...
			top3.Click += new EventHandler(OnTempClick);
        ...
        protected void CreateAppearanceMenu(MenuCommand mc)
        {
			...
			MenuCommand style0 = new MenuCommand("&Office2003", new EventHandler(OnOffice2003Selected));
			MenuCommand style1 = new MenuCommand("I&DE2005", new EventHandler(OnIDE2005Selected));
			MenuCommand style2 = new MenuCommand("&IDE", new EventHandler(OnIDESelected));
            MenuCommand style3 = new MenuCommand("&Plain", new EventHandler(OnPlainSelected));
            MenuCommand style4 = new MenuCommand("-");
            MenuCommand style5 = new MenuCommand("PlainAsBlock", new EventHandler(OnPlainAsBlockSelected));
            MenuCommand style6 = new MenuCommand("-");
            MenuCommand style7 = new MenuCommand("Dock Left", new EventHandler(OnDockLeftSelected));
            MenuCommand style8 = new MenuCommand("Dock Top", new EventHandler(OnDockTopSelected));
            MenuCommand style9 = new MenuCommand("Dock Right", new EventHandler(OnDockRightSelected));
            MenuCommand styleA = new MenuCommand("Dock Bottom", new EventHandler(OnDockBottomSelected));
            MenuCommand styleB = new MenuCommand("-");
            MenuCommand styleC = new MenuCommand("MultiLine", new EventHandler(OnMultiLineSelected));
            MenuCommand styleD = new MenuCommand("-");
            MenuCommand styleE = new MenuCommand("E&xit", new EventHandler(OnExit));

            // Setup event handlers
			style0.Update += new EventHandler(OnOffice2003Update);
			style1.Update += new EventHandler(OnIDE2005Update);
			style2.Update += new EventHandler(OnIDEUpdate);
            style3.Update += new EventHandler(OnPlainUpdate);
            style5.Update += new EventHandler(OnPlainAsBlockUpdate);
            style7.Update += new EventHandler(OnDockLeftUpdate);
            style8.Update += new EventHandler(OnDockTopUpdate);
            style9.Update += new EventHandler(OnDockRightUpdate);
            styleA.Update += new EventHandler(OnDockBottomUpdate);
            styleC.Update += new EventHandler(OnMultiLineUpdate);

            mc.MenuCommands.AddRange(new MenuCommand[]{style0,style1,style2,style3,style4,style5,style6,
                                                       style7,style8,style9,styleA,styleB,styleC,styleD,styleE});
        ...
        {
            // Create menu commands
            MenuCommand car1 = new MenuCommand("Ford", _images, 0, new EventHandler(OnGenericSelect));
            MenuCommand car2 = new MenuCommand("Vauxhall", _images, 1, new EventHandler(OnGenericSelect));
            MenuCommand car3 = new MenuCommand("Opel", _images, 2, new EventHandler(OnGenericSelect));
            MenuCommand car4 = new MenuCommand("Volvo", _images, 5, new EventHandler(OnGenericSelect));
            MenuCommand car5 = new MenuCommand("Lotus", _images, 6, Shortcut.Alt0, new EventHandler(OnGenericSelect));
            MenuCommand car6 = new MenuCommand("Aston Martin", _images, 0, Shortcut.ShiftF1, new EventHandler(OnGenericSelect));
            MenuCommand car7 = new MenuCommand("Ferrari", _images, 1, Shortcut.CtrlShift0, new EventHandler(OnGenericSelect));
            MenuCommand car8 = new MenuCommand("Jaguar", _images, 2, Shortcut.ShiftIns, new EventHandler(OnGenericSelect));
        ...
        protected void SetupStatusBar()
        {
			...
			// Create and setup a single panel for text in the StatusBar
            _statusBarPanel = new StatusPanel();
            _statusBarPanel.AutoSizing = StatusBarPanelAutoSize.Spring;
            _status.StatusPanels.Add(_statusBarPanel);
		
			// Create and setup a single panel showing the time
			_statusBarPanelTime = new StatusPanel();
			_statusBarPanelTime.AutoSizing = StatusBarPanelAutoSize.Contents;
			_status.StatusPanels.Add(_statusBarPanelTime);

			// Use timer to update status bar
			timerForTime = new Timer();
			timerForTime.Enabled = true;
			timerForTime.Interval = 300;
			timerForTime.Tick += new EventHandler(OnTimeTick);
        ...
        {
			// Strip out any & values
			_statusBarPanel.Text = text.Replace("&", "");
        }
		...
		protected void OnOffice2003Update(object sender, EventArgs e)
		{
			MenuCommand mc = sender as MenuCommand;
			mc.Checked = (_topMenu.Style == VisualStyle.Office2003);
		}
		
		protected void OnIDE2005Update(object sender, EventArgs e)
        {
            MenuCommand mc = sender as MenuCommand;
            mc.Checked = (_topMenu.Style == VisualStyle.IDE2005);
        }
		...
		protected void OnOffice2003Selected(object sender, EventArgs e)
		{
			_topMenu.Style = VisualStyle.Office2003;
			_status.Style = VisualStyle.Office2003;
			OnMenuItemSelected("Office2003");
		}
		
		protected void OnIDE2005Selected(object sender, EventArgs e)
        {
            _topMenu.Style = VisualStyle.IDE2005;
			_status.Style = VisualStyle.IDE2005;
			OnMenuItemSelected("IDE2005");
        }

		protected void OnIDESelected(object sender, EventArgs e)
        {
            _topMenu.Style = VisualStyle.IDE;
			_status.Style = VisualStyle.IDE;
        ...
        protected void OnPlainSelected(object sender, EventArgs e)
        {
			...
			_status.Style = VisualStyle.Plain;
		...
		protected void OnTimeTick(object sender, System.EventArgs e)
		{
			// Update status bar with the current time
			_statusBarPanelTime.Text = DateTime.Now.ToShortDateString();
		}
		...
		protected void OnTempClick(object sender, EventArgs e)
		{
			Console.WriteLine("OnTemoClick");
		}
		
		#region Windows Form Designer generated code
        private void InitializeComponent()
        {
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(MDIContainer));
			// 
			// MDIContainer
			// 
			...
			this.Text = "DotNetMagic - SampleMenus";
