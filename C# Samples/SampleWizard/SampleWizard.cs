...
namespace SampleWizard
{
	public class SampleWizard : Crownwood.DotNetMagic.Forms.WizardDialog
	{
		...
		public SampleWizard()
		{
			...
			WizardControl.WizardPages.AddRange(new WizardPage[]{wizardStartPage, wizardInfo1, wizardInfo2, wizardLegal, wizardWarn, wizardInstall, wizardFinish});

			// Preset the installation style of operation
			WizardControl.Profile = Profiles.Install;
		}
		...
		private void InitializeComponent()
		{
			...
			this.wizardControl.HeaderPanel.Size = new System.Drawing.Size(410, 80);
			this.wizardControl.HeaderPanel.TabIndex = 1;
			this.wizardControl.Name = "wizardControl";
			this.wizardControl.Size = new System.Drawing.Size(410, 340);
			// 
			// wizardControl.TrailerPanel
			// 
			this.wizardControl.TrailerPanel.Dock = System.Windows.Forms.DockStyle.Bottom;
			this.wizardControl.TrailerPanel.Location = new System.Drawing.Point(0, 292);
			this.wizardControl.TrailerPanel.Name = "_panelBottom";
			this.wizardControl.TrailerPanel.Size = new System.Drawing.Size(410, 48);
        ...
        private void radioButton4_CheckedChanged(object sender, System.EventArgs e)
        {
            ...
            {
               this.WizardControl.EnableNextButton = Crownwood.DotNetMagic.Controls.Status.Default;
               radioButton5.Checked = false;
            }
            else                    
            {
                this.WizardControl.EnableNextButton = Crownwood.DotNetMagic.Controls.Status.No;
